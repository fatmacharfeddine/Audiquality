                ...
                <section class="forms">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <form action="<?php echo base_url(); ?>Employee_Account/Submit_add_access_group/" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <?php } ?>
                                                        <input type="text" name="Name_access_group" value="<?php if (isset($Name_access_group)) {
                                                                                                                echo $Name_access_group;
                                                                                                            } ?>" placeholder="access_group" class="form-control">
