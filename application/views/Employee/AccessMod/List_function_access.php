        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Group Access Functions</h4>
                </div>
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Employee_Account/Form_add_functions_access?ID_access_group=' . $ID_access_group . '') ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add functions_access</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                        ...
                                                        <td class="text-right">
                                                            <div class="dropdown dropdown-action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/view_functions_access?ID_functions_access=<?php echo $row['ID_functions_access'] ?>"><i class="fa fa-pencil m-r-5"></i> View</a>
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Form_edit_functions_access?ID_functions_access=<?php echo $row['ID_functions_access'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Delete_functions_access?ID_functions_access=<?php echo $row['ID_functions_access'] ?>" name="btn_delete" id="btn_delete"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
