                                                            ...
                                                            <td class="text-right">
                                                                <div class="dropdown dropdown-action">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        ...
                                                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Delete_department?ID_department=<?php echo $row['ID_department'] ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td>
