        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 col-6 text-right m-b-30">
                    <a href="<?php echo base_url(); ?>Employee_Account/Form_edit_department?ID_department=<?php echo $ID_department ?>" class="btn btn-primary btn-rounded"><i class="fa fa-pencil m-r-5"></i> Edit Department</a>
                </div>
            </div>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="profile-info-left">
                                            ...
                                            <?php         } else { ?>
                                                ...
                                                <div class="staff-msg"><a href="<?php echo site_url('Employee_Account/Form_add_department_post?ID_department=' . $ID_department . '') ?>" class="btn btn-primary">+ Add Position</a></div>
                                            <?php } ?>
                                                ...
                                                ?>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="row experience-content">
                                                            ...
                                                            <div class="col-md-2">
                                                                <a href="<?php echo base_url(); ?>Employee_Account/Form_edit_department_post?ID_department_post=<?php echo $row['ID_department_post'] ?>">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <form id="popup" action="<?php echo base_url(); ?>Employee_Account/Delete_department_post?ID_department_post=<?php echo $row['ID_department_post'] ?>" enctype="multipart/form-data" method="post">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                    <tr role="row" class="odd">
                                                                        ...
                                                                        <td class="text-right">
                                                                            <a href="<?php echo base_url(); ?>Employee_Account/List_skills_employee?ID_employee=<?php echo $row['ID_employee'] ?>" class="btn btn-outline-primary take-btn">View Profile</a>
                                                                        </td>
                                                                        <!--td class="text-right">
