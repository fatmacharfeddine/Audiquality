                                            ...
                                            ?>
                                                    ...
                                                    ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url() ?>/Employee_Account/View_employee_details?ID_employee=<?php echo $row['ID_employee'] ?>">
                                                            ...
                                                            <td class="text-right">
                                                                <a href="<?php echo base_url(); ?>Employee_Account/List_skills_employee?ID_employee=<?php echo $row['ID_employee'] ?>" class="btn btn-outline-primary take-btn">Skills</a>
                                                            </td>
                                                            <!--td class="text-right">
