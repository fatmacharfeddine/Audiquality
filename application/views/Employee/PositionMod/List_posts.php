        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Employee_Account/Form_add_post') ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add position</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td><a href="<?php echo base_url() ?>/Employee_Account/view_fiche?ID_post=<?php echo $row['ID_post'] ?>">
                                                        ...
                                                        <td class="text-right">
                                                            <a href="<?php echo base_url(); ?>Employee_Account/List_skills_management?ID_post=<?php echo $row['ID_post'] ?>" class="btn btn-outline-primary take-btn">Skills</a>
                                                        </td>
                                                        <td class="text-right">
                                                            <a href="<?php echo base_url(); ?>Employee_Account/Form_edit_post?ID_post=<?php echo $row['ID_post'] ?>">
                                                                <button class="btn btn-primary btn-primary-three float-right"><i class="fa fa-pencil m-r-5"></i>Update</button>
                                                            </a>
                                                        </td>
                                                        <!--td class="text-right">
                                                            <form  action="<?php echo base_url(); ?>Employee_Account/Delete_post?ID_post=<?php echo $row['ID_post'] ?>" enctype="multipart/form-data" method="post">
                                                                <button class="btn btn-primary btn-primary-four float-right" type="button"><i class="fa fa-trash-o m-r-5"></i>Delete</button>
                                                            </form>
                                                        </;td-->
                                                        <td class="text-right">
                                                            <a href="<?php echo base_url(); ?>Employee_Account/Delete_post?ID_post=<?php echo $row['ID_post'] ?>">
                                                                <button class="btn btn-primary btn-primary-four float-right" type="button"><i class="fa fa-trash-o m-r-5"></i>Delete</button>
                                                            </a>
                                                        </td>
                                                        <!--div class="dropdown dropdown-action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <!--a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/view_post?ID_post=<?php echo $row['ID_post'] ?>"><i class="fa fa-pencil m-r-5"></i> View</a-->
                                                        <!--a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/List_skills_management?ID_post=<?php echo $row['ID_post'] ?>"><i class="fa fa-pencil m-r-5"></i> Skills</a>
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Form_edit_post?ID_post=<?php echo $row['ID_post'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>

                                                                    <form id="popup" action="<?php echo base_url(); ?>Employee_Account/Delete_post?ID_post=<?php echo $row['ID_post'] ?>" enctype="multipart/form-data" method="post">
