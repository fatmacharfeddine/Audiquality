            ...
            <div class="container-fluid content-top-gap">
                ...
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb my-breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sous-activité</li>
                    </ol>
                </nav>
                <!-- //breadcrumbs -->
                <!-- forms -->
                <section class="forms">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <form id="audits" enctype="multipart/form-data" action="<?php echo base_url(); ?>Employee_Account/submit_add_processusgritem" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-form-label col-md-12">Activités du processus</label>
                                                    <textarea cols="30" rows="4" class="form-control" name="ActivityItem"></textarea>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-3">Eléments de preuves / Enregistrements</label>
                                                    <div class="col-md-9">
