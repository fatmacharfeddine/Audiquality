            ...
            <div class="container-fluid content-top-gap">
                <section class="forms">
                    ...
                    <div class="row" style="margin-bottom:2%">
                        <a href="<?php echo base_url() ?>/Employee_Account/Generate_Processus?ID_processus=<?php echo $ID_processus ?>" class="btn btn-success btn-block" style="margin-left: 35%; width: 30%;background-color: #eb1c24;border: 1px solid #eb1c24;">Generate Report </a>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                                ...
                                                foreach ($activity as $row) { ?>
                                                    ...
                                                    <tr>
                                                        <td colspan="5" style="text-align: center;">
                                                            <a href="<?php echo base_url() ?>/Employee_Account/Form_add_processusgritem?ID_processus=<?php echo $ID_processus ?>&GroupID=<?php echo $row['GroupID'] ?>">
                                                                <button class="btn btn-primary btn-primary-two" style="width: 200px;"> + Ajouter Sous-activité</button>
                                                            </a>
                                                        </td>
                                            ...
                                            <tr class="table-primary">
                                                <td colspan="5" style="text-align: center;">
                                                    <a href="#" data-toggle="modal" data-target="#activity">
                                                        <button class="btn btn-primary btn-primary-two" style="width: 200px;"> + Ajouter Activité</button>
                                                    </a>
                                                </td>
