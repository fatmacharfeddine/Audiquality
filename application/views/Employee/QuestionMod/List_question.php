                ...
                <div class="col-sm-8 col-3">
                    <h4 class="page-title">
                        <?php if (isset($question)) {
                            echo $question[0]['Title_subject'];
                        } ?>
                    </h4>
                </div>
                <div class="col-sm-4 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Employee_Account/Form_add_question') ?>?ID_chapter=<?php echo $ID_chapter ?>&ID_subject=<?php echo $ID_subject ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Question</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-border table-striped custom-table datatable mb-0 dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 142px;">Question</th>
                                            ...
                                            ?>
                                                    ...
                                                    ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><?= $row['Text_question'] ?></td>
                                                            <td class="text-right">
