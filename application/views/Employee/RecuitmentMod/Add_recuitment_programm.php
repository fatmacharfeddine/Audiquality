...
<script>
    function triggerClick() {
        document.querySelector('#File_recuitment_programm').click();
    }
            ...
            <div class="container-fluid content-top-gap">
                ...
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb my-breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">recuitment_programm</li>
                    </ol>
                </nav>
                <!-- //breadcrumbs -->
                <!-- forms -->
                <section class="forms">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <form id="popup" action="<?php echo base_url(); ?>Employee_Account/Submit_add_recuitment_programm/" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-3">Nom du recru</label>
                                                    <div class="col-md-9">
                                                        <?php if (isset($ID_recuitment_programm)) {
                                                        ?>
                                                            <input type="hidden" name="ID_recuitment_programm" value="<?php echo $ID_recuitment_programm ?>">
                                                        <?php } ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <img id="target">
                                                        <input type="file" accept=".pdf, .docx" id="File_recuitment_programm" name="File_recuitment_programm" onchange="displayImage(this)" style="display:none;">
