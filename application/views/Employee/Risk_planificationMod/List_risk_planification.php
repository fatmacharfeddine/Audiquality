                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <a href="<?php echo base_url() ?>/Employee_Account/List_risk_planification_by_type?processcategory=1" class="read-more"><i class="fa fa-long-arrow-right"></i> Open</a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <a href="<?php echo base_url() ?>/Employee_Account/List_risk_planification_by_type?processcategory=2" class="read-more"><i class="fa fa-long-arrow-right"></i> Open</a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <a href="<?php echo base_url() ?>/Employee_Account/List_risk_planification_by_type?processcategory=3" class="read-more"><i class="fa fa-long-arrow-right"></i> Open</a>
