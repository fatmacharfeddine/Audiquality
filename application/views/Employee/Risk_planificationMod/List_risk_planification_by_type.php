                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td style="border-color: #b8daff;">
                                                <a href="<?php echo base_url() ?>/Employee_Account/delete_risk_planification?ID_risk_planification=<?php echo $row['ID_risk_planification'] ?>&ID_processus=<?php echo $current_processus ?>&processcategory=<?php echo $processcategory; ?>">
