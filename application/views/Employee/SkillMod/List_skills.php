        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Employee_Account/Form_add_skill') ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Skill</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($skills as $row) { ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-right">
                                                            <a href="<?php echo base_url() ?>/Employee_Account/List_employees_skill?ID_skill=<?php echo $row['ID_skill'] ?>" class="btn btn-outline-primary take-btn">Employees</a>
                                                        </td>
                                                        <td class="text-right">
                                                            <div class="row">

                                                                <div class="col-md-6">
                                                                    <a href="<?php echo base_url(); ?>Employee_Account/Form_edit_skill?ID_skill=<?php echo $row['ID_skill'] ?>">
                                                                        <button class="btn btn-primary btn-primary-three float-right"><i class="fa fa-pencil m-r-5"></i>Update</button>
                                                                    </a>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <form id="popup" action="<?php echo base_url(); ?>Employee_Account/Delete_skill?ID_skill=<?php echo $row['ID_skill'] ?>" enctype="multipart/form-data" method="post">
                                                            ...
                                                            <!--div class="dropdown dropdown-action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/view_skill?ID_skill=<?php echo $row['ID_skill'] ?>"><i class="fa fa-pencil m-r-5"></i> View</a>
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Form_edit_skill?ID_skill=<?php echo $row['ID_skill'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                                    <form id="popup" action="<?php echo base_url(); ?>Employee_Account/Delete_skill?ID_skill=<?php echo $row['ID_skill'] ?>" enctype="multipart/form-data" method="post">
