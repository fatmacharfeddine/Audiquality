                                            ...
                                            <div class="widget post-widget">
                                                ...
                                                <ul class="latest-posts">
                                                    <li>
                                                        <div class="post-thumb">
                                                            <a href="blog-details.html">
                                                                <img class="img-fluid" src="<?= base_url() ?>/includes/ext/assets/template/img/RH/dep.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="post-info" style="margin-top: 2%;">
                                                            <ul class="categories">
                                                                <li><a href="<?php echo base_url() ?>/Employee_Account/List_departments"><i class="fa fa-check-circle-o"></i> <span>Departments </span></a></li>
                                            ...
                                            <div class="widget post-widget">
                                                ...
                                                <ul class="latest-posts">
                                                    <li>
                                                        <div class="post-thumb">
                                                            <a href="blog-details.html">
                                                                <img class="img-fluid" src="<?= base_url() ?>/includes/ext/assets/template/img/RH/emp.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="post-info" style="margin-top: 2%;">
                                                            <ul class="categories">
                                                                <li><a href="<?php echo base_url() ?>/Employee_Account/List_employee_new"><i class="fa fa-check-circle-o"></i> <span>Employees </span></a></li>
                        ...
                        <div class="col-md-4 col-sm-4  col-lg-3">
                            <div class="profile-widget">
                                <div class="doctor-img">
                                    <a class="avatar" href="">
                                        <img alt="" src="<?php echo base_url() ?>//includes/ext/assets/template/img/followup.jpg"></a>
                                </div>
                                <div class="dropdown profile-action">
                                    <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Form_edit_followup?ID_followup=<?php echo $row['ID_followup']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Delete_followup?ID_followup=<?php echo $row['ID_followup']; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                    </div>
                                </div>
                                <a href="<?php echo base_url(); ?>Employee_Account/View_followup?ID_followup=<?php echo $row['ID_followup']; ?>">
                                    <h4 class="doctor-name text-ellipsis">
                                        <?php echo $row['Title_followup']; ?>
                                </a>
                                </h4>

                                <div class="user-country">
                                    <i style='font-size:16px' class='far'>&#xf02e;</i>
                                    <?php echo $row['Date_followup']  ?>


                                </div>
                                <div class="doc-prof" style="color:#009efb">
                                    <a href="<?php echo base_url(); ?>uploads/followup/<?php echo $row['File_followup'] ?>">Open File</a>
                                </div>
                            </div>
