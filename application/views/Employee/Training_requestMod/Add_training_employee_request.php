                        ...
                        <div class="row">
                            <div class="card-box">
                                ...
                                <form id="test" action="<?php echo base_url(); ?>Employee_Account/Submit_add_training_request/" enctype="multipart/form-data" method="post">
                                    ...
                                    <?php } ?>
                                    <div class="row">
                                    <input type="hidden" name="Createdby_training_request" value="0">
                                        ...
                                        <div class="col-md-12">
                                            <select class="form-control floating" name="ID_training_group_request">
                                                <?php
                                                foreach ($group_training as $row) {
