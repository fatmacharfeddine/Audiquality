                                            ...
                                            ?>
                                                    ...
                                                    ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td><a href="<?php echo base_url() ?>/Employee_Account/View_trainings_eval_by_prog?ID_training_programm=<?=$row['ID_training_programm']?>&Year_training_programm=<?=$row['Year_training_programm']?>">View <i class="fa fa-eye" aria-hidden="true"></i></a></td>
