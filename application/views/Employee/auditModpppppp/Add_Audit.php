                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <!--input type="month" name="planned_date_audit" min="2020-01" value="2020-12"-->

                                                        <?php

                                                        $startdate = $Year_audit_plan . "-01-01";
                                                        $enddate = $Year_audit_plan . "-12-31";
                                                        ?>

                                                        <input type="date" class="form-control" id="planned_date_audit" name="planned_date_audit" min="<?php echo $startdate; ?>" max="<?php echo $enddate; ?>">
