                ...
                <section class="forms">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <form id="audits" action="<?php echo base_url(); ?>Employee_Account/submit_Team?ID_team=<?php echo $ID_team; ?>" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-3">Name Team</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="Name_team" value="<?php echo $Name_team ?>">
