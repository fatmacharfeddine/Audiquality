                        ...
                        <table class="table table-striped custom-table mb-0">
                            ...
                            <tbody>
                                <?php if (isset($departement)) {
                                    foreach ($departement_list as $row) {
                                                ...
                                                for ($i = 0; $i <= 11; $i++) { ?>
                                                    ...
                                                    <td>
                                                        <?php foreach ($departement as $row2) {
                                                            ...
                                                            if (($date->format('m') == $month_array[$i]) && ($row['ID_department'] == $row2['ID_department'])) {
                                                        ?>
                                                                <a href="<?php echo base_url() ?>/Employee_Account/View_processus?ID_audit=<?php echo $row2['ID_audit'] ?>&ID_department=<?php echo $row['ID_department'] ?>"><!--&planned_date_audit=<?php echo $row['planned_date_audit'] ?>---->
