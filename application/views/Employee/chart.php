...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url().'includes/chart/'?>assets/img/favicon.ico">
    <title>Audit Quality - Medical & Hospital - Bootstrap 4 Admin Template</title>
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'includes/chart/'?>assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'includes/chart/'?>assets/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'includes/chart/'?>assets/css/style.css">
    <!--[if lt IE 9]>
...
<body>
        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="assets/img/logo.png" width="35" height="35" alt=""  style="border-radius: 50%;"> <span>Audit Quality</span>
				</a>
			</div>
    ...
    <script src="<?php echo base_url().'includes/chart/'?>assets/js/jquery-3.2.1.min.js"></script>
	<script src="<?php echo base_url().'includes/chart/'?>assets/js/popper.min.js"></script>
    <script src="<?php echo base_url().'includes/chart/'?>assets/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url().'includes/chart/'?>assets/js/jquery.slimscroll.js"></script>
    <script src="<?php echo base_url().'includes/chart/'?>assets/js/Chart.bundle.js"></script>
    <script src="<?php echo base_url().'includes/chart/'?>assets/js/chart.js"></script>
    <script src="<?php echo base_url().'includes/chart/'?>assets/js/app.js"></script>
