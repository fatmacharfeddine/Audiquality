...
<body>
    ...
    <div class="page-wrapper" style="min-height: 314px;">
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <form id="audits" enctype="multipart/form-data" action="<?php echo base_url(); ?>Employee_Account/Submit_Update_Enjeu_Interne?ID_enjeu=<?php echo $ID_enjeu ?>" enctype="multipart/form-data" method="post">
                        <div class="row">
