                    ...
                    <div class="blog-view">
                        <article class="blog blog-single-post">
                            ...
                            <div class="blog-image">
                                <a href="#.">
                                    <img alt="" src="<?php echo base_url() ?>/includes/ext/assets/template/img/context/<?php if (isset($photo_swot)) {
                                                                                                                            foreach ($photo_swot as $row) {
                                                                                                                                echo $row['photo_swot'];
                                                                                                                            }
                                                                                                                        }  ?>" class="img-fluid">
                                </a>
                                            ...
                                            <div class="contact-cont">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <a href="<?php echo base_url(); ?>Employee_Account/delete_enjeu_swot?ID_enjeu=<?php echo $row['ID_enjeu'] ?>&ID_swot=<?php echo $ID_swot ?>">
