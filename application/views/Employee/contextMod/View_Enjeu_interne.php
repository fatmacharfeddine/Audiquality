...
<body>
    ...
    <div class="page-wrapper" style="min-height: 314px;">
        <div class="content">
            <div class="row">
                <h4 class="payslip-title" style="margin-left: 30%;">Liste des Enjeux Internes de type <?php if ($ID_swot == 1) {
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="<?php echo base_url() ?>/Employee_Account/Update_Enjeu_interne?ID_enjeu=<?php echo $row['ID_enjeu'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                        <a class="dropdown-item" href="<?php echo base_url() ?>/Employee_Account/Delete_EnjeuInterne?ID_enjeu=<?php echo $row['ID_enjeu'] ?>&ID_swot=<?php echo $ID_swot ?>" onclick="return confirm('Are you Sure?')"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
