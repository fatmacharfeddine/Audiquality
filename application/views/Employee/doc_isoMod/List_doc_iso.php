            ...
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">
                        ...
                        if (($Type_doc_iso) == 4) {
                            echo "Enregistrements & Formulaires";
                        }
                        ?>
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Employee_Account/Form_add_doc_iso?Type_doc_iso=') ?><?php echo $Type_doc_iso ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add document</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <table class="table table-border table-striped custom-table datatable mb-0 dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                <thead>
                                                    <tr role="row">
                                                        <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 142px;">doc_iso</th>
                                                ...
                                                <tbody>
                                                    <?php foreach ($doc_iso as $row) { ?>
                                                        <tr role="row" class="odd">



                                                            <td class="sorting_1"><?= $row['Title_doc_iso'] ?></td>
                                                            <td><?= $row['File_doc_iso'] ?></td>

                                                            <td class="text-right">
                                                                <a class="btn btn-primary btn-primary-four" href="<?php echo base_url(); ?>Employee_Account/Delete_doc_iso?ID_doc_iso=<?php echo $row['ID_doc_iso'] ?>&Type_doc_iso=<?php echo $Type_doc_iso; ?>"><i class="fa fa-trash-o m-r-5"></i> </a>
                                                            </td>
