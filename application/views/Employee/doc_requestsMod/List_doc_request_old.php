        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">doc_requests</h4>
                </div>
                                            ...
                                            <table class="table table-border table-striped custom-table datatable mb-0 dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="text-center" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 30px;">Status</th>
                                                    ...
                                                    ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <?php  } else if ($row['Validatedby_requests'] == -1) { ?>
                                                                ...
                                                                <?php } else { ?>
                                                                    <div class="dropdown action-label show">
                                                                        <a class="custom-badge status-green dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="true">
                                                                            Accepted
                                                                        </a>
                                                                        <div class="dropdown-menu dropdown-menu-right show" x-placement="top-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-57px, -124px, 0px);">
                                                                            <?php if ($row['Type_requests'] == 0) {
                                                                                if ($row['ID_document'] != 0) { ?>
                                                                                    <a style="color:grey" class="dropdown-item" href="">Document Created !! </a>

                                                                                    <?php        } else { ?>
                                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Form_add_document?ID_requests=<?php echo $row['ID_requests'] ?>">Create Document</a>

                                                                                <?php }
                                                                            } else if ($row['Type_requests'] == 1) { ?>
                                                                               
                                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Form_edit_document?ID_requests=<?php echo $row['ID_requests'] ?>">Update Document</a>
                                                                            <?php 
                                                                            } ?>
                                                                        </div>
                                                                    </div>
