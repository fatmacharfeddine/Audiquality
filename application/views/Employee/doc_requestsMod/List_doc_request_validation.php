                                    ...
                                    <table class="table table-border table-striped custom-table datatable mb-0 dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="text-center" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 30px;">QSE Director</th>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                ?>
                                                                            <span class="custom-badge status-grey">Waiting</span>
                                                            <td>
                                                                <!--a href="<?php echo base_url(); ?>Employee_Account/List_doc_request_validation?Type_requests=<?php echo $Type_requests; ?>&action=accept">
                                                                    <button class="btn btn-primary btn-primary-one float-right">Refuse</button>
                                                                </a>
                                                                <a href="<?php echo base_url(); ?>Employee_Account/List_doc_request_validation?Type_requests=<?php echo $Type_requests; ?>&action=refuse">
                                                                    <button class="btn btn-primary btn-primary-three float-right">Accept</button>
                                                                </a-->
                                                                <a href="<?php echo base_url(); ?>Employee_Account/List_doc_request_validation?Type_requests=<?php echo $Type_requests; ?>&action=accept&ID_requests=<?php echo $row['ID_requests'] ?>" class="btn btn-outline-primary take-btn">Accept</a>
                                                                <a href="<?php echo base_url(); ?>Employee_Account/List_doc_request_validation?Type_requests=<?php echo $Type_requests; ?>&action=refuse&ID_requests=<?php echo $row['ID_requests'] ?>" class="btn btn-outline-primary take-btn">Refuse</a>

                                                            </td>

                                                            <?php  } else if ($row['Validatedby_requests'] != 0) {
                                                                            if ($row['Refusedstatus_requests'] == 2) { ?>
                                                                <span class="custom-badge status-red">Refused</span>

                                                            <?php    } else if ($row['Refusedstatus_requests'] == 1) {
                                                                            } else if ($row['Refusedstatus_requests'] == 0) { ?>
                                                                <span class="custom-badge status-green">Accepted</span>

                                                            <?php    }
                                                            ?>
                                                            <td></td>
                                                        <?php } else if ($row['Type_requests'] == 2) { ?>
                                                            <span class="custom-badge status-green">Accepted</span>
                                                            <td></td>
                                                ...
                                                <td>
                                                    <?php
                                                        if (($row['Revisedby_version'] != 0)) {
                                                            if (($row['Validatedby_requests'] != 0) & ($row['Refusedstatus_requests'] == 0)) {
