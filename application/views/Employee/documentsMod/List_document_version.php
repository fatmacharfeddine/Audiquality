                                                    ...
                                                    foreach ($doc as $row) {
                                                        ...
                                                        if ($i == 1) { ?>
                                                            <tr role="row" class="table-warning">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                                            <a href="<?php echo base_url(); ?>Employee_Account/Detail_document?ID_version=<?php echo $row['ID_version'] ?>&action=accept" class="btn btn-outline-primary take-btn">Accept</a>
                                                                            <a href="<?php echo base_url(); ?>Employee_Account/Detail_document?ID_version=<?php echo $row['ID_version'] ?>&action=refuse" class="btn btn-outline-primary take-btn">Refuse</a>
                                                                    ...
                                                                    <?php if (isset($validation_form)) {
                                                                        if ($row['Revisedby_version'] == 0) { ?>
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <?php
                                                                            } else if ($row['Refusedstatus_version'] == 0) {
                                                        ...
                                                        ?>
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo base_url(); ?>Employee_Account/Detail_document?ID_document=<?php echo $row['ID_document']; ?>">
                                                                        <button class="btn btn-primary btn-primary-two float-right">View</button>
                                                                    </a>
                                                                </td>
                                                            </tr>
