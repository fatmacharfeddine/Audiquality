        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Employee_Account/Form_add_field') ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add field</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-border table-striped custom-table datatable mb-0 dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 142px;">field</th>
                                            ...
                                            ?>
                                                    ...
                                                    ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="sorting_1"><?= $row['Title_field'] ?></td>
                                                            ...
                                                            <td class="text-right">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <a href="<?php echo base_url(); ?>Employee_Account/Form_edit_field?ID_field=<?php echo $row['ID_field'] ?>">
                                                                            <button class="btn btn-primary btn-primary-three float-right"><i class="fa fa-pencil m-r-5"></i>Update</button>
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <a href="<?php echo base_url(); ?>Employee_Account/Delete_field?ID_field=<?php echo $row['ID_field'] ?>">
                                                            ...
                                                            <!--td class="text-right">
                                                                <div class="dropdown dropdown-action">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Form_edit_field?ID_field=<?php echo $row['ID_field'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Delete_field?ID_field=<?php echo $row['ID_field'] ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td-->
