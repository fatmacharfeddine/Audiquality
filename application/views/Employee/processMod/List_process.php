        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Processess</h4>
                </div>
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Employee_Account/Form_add_process') ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add process</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                    ...
                                                    ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td style="min-width: 200px;">
                                                                <img width="28" height="28" class="rounded-circle" src="<?php echo base_url() ?>/uploads/process/<?php echo $row['Picture_process'] ?>" alt="">
                                                                <h2><?= $row['Name_process'] ?></h2>
                                                            </td>
                                                            ...
                                                            <td class="text-right">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <a href="<?php echo base_url(); ?>Employee_Account/Form_edit_process?ID_process=<?php echo $row['ID_process'] ?>">
                                                                            <button class="btn btn-primary btn-primary-three float-right"><i class="fa fa-pencil m-r-5"></i>Update</button>
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <a href="<?php echo base_url(); ?>Employee_Account/Delete_process?ID_process=<?php echo $row['ID_process'] ?>">
                                                            ...
                                                            <!--td class="text-right">
                                                                <div class="dropdown dropdown-action">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Form_edit_process?ID_process=<?php echo $row['ID_process'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Employee_Account/Delete_process?ID_process=<?php echo $row['ID_process'] ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td-->
