                ...
                <section class="forms">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <form id="risks" action="<?php echo base_url(); ?>Employee_Account/Submit_add_sector/" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-3">Sector </label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="Title_sector" value="<?php if (isset($Title_sector)) {
                                                                                                                                echo $Title_sector;
