                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <?php
                                                                $link = "Detail_document?ID_document=";

                                                                if (isset($revision_mode)) {
                                                                    $link = "Detail_document?ID_document=";
                                                                } else if (isset($validation_mode)) {
                                                                    $link = "Detail_document_validation?ID_document=";
                                                                }
                                                                ?>
                                                                <a href="<?php echo base_url(); ?>Employee_Account/<?php echo $link . $row['ID_document']; ?>">
