            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <a class="dropdown-item" href="settings.html">Settings</a-->
                        ...
                        <li>
                            <a href="<?php echo site_url('Employee/Department') ?>"><i class="fa fa-user-md"></i> <span>Departments</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Employee/Chapters') ?>"><i class="fa fa-user-md"></i> <span>Chapters</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Employee/Subjects') ?>"><i class="fa fa-user-md"></i> <span>Subjects</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Employee/Questions') ?>"><i class="fa fa-user-md"></i> <span>Questions</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Employee/Responses') ?>"><i class="fa fa-user-md"></i> <span>Responses</span></a>
                        </li>
                        <li>
